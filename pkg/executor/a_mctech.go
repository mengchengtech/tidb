...
func (e *mctechLargeQueryRetriever) dataForLargeQuery(ctx context.Context, _ sessionctx.Context) ([][]types.Datum, error) {
	var (
...
func (a *ExecStmt) SaveLargeQuery(succ bool) {
	...
	largeLog := sessVars.LargeQueryFormat(largeItems)
