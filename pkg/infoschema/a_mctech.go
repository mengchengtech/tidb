...
var mctechLargeQueryCols = []columnInfo{
	...
	{name: variable.MCLargeQueryAppNameStr, tp: mysql.TypeVarchar, size: 128},
	{name: variable.MCLargeQueryProductLineStr, tp: mysql.TypeVarchar, size: 128},
	{name: variable.MCLargeQueryPackageStr, tp: mysql.TypeVarchar, size: 128},
