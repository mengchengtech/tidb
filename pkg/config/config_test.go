...
`)
	...
	conf.MCTech = MCTech{
		...
		Metrics: MctechMetrics{
			...
			LargeLog: LargeLog{Enabled: false, Filename: "mctech_large_query_log.log", FileMaxDays: 3, FileMaxSize: 512, Threshold: 4194304, Types: []string{"delete", "insert", "update", "select"}},
