...
`)
	...
	conf.MCTech = MCTech{
		...
		DbChecker:  DbChecker{Enabled: false, APIPrefix: "http://node-infra-dim-service.mc/", Mutex: []string{"asset_*", "global_*"}, Exclude: []string{"global_platform", "global_ipm", "global_dw_*", "global_dwb"}},
