...
func NewTiFlashTableRules(tbl *model.TableInfo, bundle *placement.Bundle) []*pdhttp.Rule {
...
func NewTiFlashPartitionRule(partID int64, tbl *model.TableInfo, bundle *placement.Bundle) *pdhttp.Rule {
	if tbl.TiFlashReplica == nil {
		// 跳过不存在tiflash的表
		return nil
	}
