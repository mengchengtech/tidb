...
func TestCheckSQLDigest(t *testing.T) {
	...
	failpoint.Enable("github.com/pingcap/tidb/pkg/mctech/worker/GetDenyDigestInfo", mock.M(t, "digest-2"))
	defer failpoint.Disable("github.com/pingcap/tidb/pkg/mctech/worker/GetDenyDigestInfo")
