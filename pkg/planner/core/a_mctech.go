...
func (e *Execute) getExtensionParams(ctx context.Context, prepared *PlanCacheStmt) []ast.ParamMarkerExpr {
...
func (e *Execute) AppendVarExprs(ctx context.Context, prepared *PlanCacheStmt) error {
	// 获取扩展参数列表
