...
func TestMCTechSequenceDefaultValueSchemaTest(t *testing.T) {
	...
	failpoint.Enable("github.com/pingcap/tidb/pkg/mctech/ddl/DDLExtension", mock.M(t, true))
	defer func() {
		failpoint.Disable("github.com/pingcap/tidb/pkg/config/GetMCTechConfig")
		failpoint.Disable("github.com/pingcap/tidb/pkg/mctech/ddl/DDLExtension")
	}()
