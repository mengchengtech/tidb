...
func TestBuildMCTechTenantEnabled(t *testing.T) {
	...
	cases := []testBuildMCTechCase{
		{"demo-service", "", []string{"gslq"}, []string{"ys", "ys2"}, false, false, "", "", false, "", "1|ys,ys2|gslq|{demo-service,}||none|%s|18446744073709551615|{\"mpp\":\"allow\"}|SELECT * FROM `%s`.`t1`%s"},
		{"demo-service.pf0", "", []string{"gslq", "mctech"}, []string{"ys2"}, false, false, "disable", "", false, "", "1|ys2|gslq,mctech|{demo-service.pf0,}||none|%s|18446744073709551615|{\"mpp\":\"disable\"}|SELECT * FROM `%s`.`t1`%s"},
		{"demo-service.pf1", "@mctech/dp-impala", []string{"gslq", "mctech"}, nil, false, false, "force", "", false, "", "1||gslq,mctech|{demo-service.pf1,@mctech/dp-impala}||none|%s|18446744073709551615|{\"mpp\":\"force\"} SELECT * FROM `%s`.`t1`%s"},
		{"demo-service.pf2", "@mctech/dp-impala", nil, nil, false, false, "allow", "", true, "gslq", "0|||{demo-service.pf2,@mctech/dp-impala}|gslq|hint|%s|18446744073709551615|{\"impersonate\":\"tenant_only\",\"mpp\":\"allow\",\"tenant\":\"gslq\"}|SELECT * FROM `%s`.`t1`%s"},
		{"demo-service.pf3", "@mctech/dp-impala", nil, nil, false, false, "", "code_sxlq", true, "", "0|||{demo-service.pf3,@mctech/dp-impala}|sxlq|role|%s|18446744073709551615|{\"impersonate\":\"tenant_only\",\"mpp\":\"allow\",\"tenant\":\"sxlq\"}|SELECT * FROM `%s`.`t1`%s"},
		{"demo-service.pf4", "@mctech/dp-impala", nil, nil, true, false, "allow", "code_mctest", true, "", "0|||{demo-service.pf4,@mctech/dp-impala}|mctest|role|%s|18446744073709551615|{\"impersonate\":\"tenant_only\",\"mpp\":\"allow\",\"tenant\":\"mctest\"}|SELECT * FROM `%s`.`t1`%s"},
		{"demo-service.pf4", "@mctech/dp-impala", nil, nil, true, false, "allow", "code_mctest", true, "mctest", "0|||{demo-service.pf4,@mctech/dp-impala}|mctest|role|%s|18446744073709551615|{\"impersonate\":\"tenant_only\",\"mpp\":\"allow\",\"tenant\":\"mctest\"}|SELECT * FROM `%s`.`t1`%s"},
		// tenant_omit
		{"demo-service.pf5", "", nil, []string{"ys", "ys2"}, false, true, "", "", false, "mctest", "1|||{demo-service.pf5,}||none|%s|18446744073709551615|{\"mpp\":\"allow\",\"tenant\":\"mctest\"}|SELECT * FROM `%s`.`t1`%s"},
	}
