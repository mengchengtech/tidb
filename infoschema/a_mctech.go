...
var mctechLargeQueryCols = []columnInfo{
	...
	{name: variable.MCTechLargeQueryAppNameStr, tp: mysql.TypeVarchar, size: 128},
	{name: variable.MCTechLargeQueryProductLineStr, tp: mysql.TypeVarchar, size: 128},
	{name: variable.MCTechLargeQueryPackageStr, tp: mysql.TypeVarchar, size: 128},
